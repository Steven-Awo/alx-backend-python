#!/usr/bin/env python3
''' Description: Import async_generator from the previous task
...
async def async_comprehension() -> List[float]:
    ''' Returing then list of values that were yielded by
    the async_generator. '''
    return [valuee async for valuee in async_generator()]
